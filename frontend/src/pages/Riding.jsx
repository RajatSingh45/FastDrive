...
//       <Link
//         to="/home"
//         className="fixed right-2 top-2 lg:right-4 lg:top-4 flex items-center justify-center rounded-full w-10 h-10 lg:w-12 lg:h-12 bg-white shadow-lg hover:bg-gray-100 transition-colors z-50"
//       >
//         <i className="text-lg lg:text-xl font-medium ri-home-2-line"></i>
//       </Link>
...
//       {/* Ride Info - Responsive */}
//       <div className="h-1/2 lg:h-full lg:w-1/3 p-4 lg:p-6 bg-white lg:border-l lg:border-gray-200">
...
//           />
//           <div className="text-right">
//             <h2 className="text-xl lg:text-2xl font-medium capitalize">
//               {ride?.captain?.fullname.firstname}
//             </h2>
//             <h4 className="text-lg lg:text-xl font-semibold -mt-1 -mb-1">
//               {ride?.captain?.veichle.plate}
//             </h4>
//             <p className="text-base lg:text-lg text-gray-600">Maruti Suzuki Alto</p>
//           </div>
//         </div>
        
//         <div className="space-y-4 lg:space-y-6">
//           <div className="flex items-center gap-5 p-3 border-b-2">
//             <i className="ri-map-pin-line text-lg lg:text-xl"></i>
//             <div>
//               <p className="text-base lg:text-lg -mt-1 text-gray-600">{ride?.drop}</p>
//             </div>
//           </div>
...
//             <div>
//               <h3 className="text-lg lg:text-xl font-medium">Rs{ride?.fare}</h3>
//             </div>
//           </div>
          
//           <button
//             className="w-full bg-gray-800 hover:bg-black text-white font-semibold p-3 lg:p-4 rounded-lg mt-3 lg:mt-6 transition-colors cursor-pointer text-lg lg:text-xl"
