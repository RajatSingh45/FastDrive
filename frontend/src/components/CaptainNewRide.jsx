  ...
  return (
    <div>
      ...
      <div className="border-b-2 ">
        <div className="flex items-center justify-between p-3 bg-gray-300 rounded-lg mt-4 mb-4">
          <div className="flex items-center gap-3">
            <img
              ...
              alt=""
            />
            <h2 className="text-lg font-semibold">{ride?.user?.fullname.firstname + " " + ride?.user?.fullname.lastname}</h2>
          </div>
      ...
      <div className="flex gap-2 justify-between flex-col items-center">
        <div className="w-full mt-5">
          <div className="mb-4 ml-2">
            <h4 className="text-black text-sm font-semibold">PICK UP</h4>
            <p className="text-base -mt-1 text-gray-600">
              {ride?.pickup}
            </p>
          </div>
          <div className="mb-4 ml-2">
            <h4 className="text-black text-sm font-semibold">DROP OFF</h4>
            <p className="text-base -mt-1 text-gray-600">{ride?.drop}</p>
          </div>
        </div>
        <div className="flex items-center justify-between w-full mt-5">
         <button className="bg-green-400 font-semibold p-3 px-10 rounded-lg" onClick={()=>{
          setconfirmRide(true)
          confirmRideHandler()
         }}>
          Accept
        ...
        <button className="bg-red-400 font-semibold p-3 px-10 rounded-lg" onClick={()=>{
          setridePopUp(false)
        }}>
          Ignore
        </button>
